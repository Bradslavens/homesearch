...
@section('section')
    ...
    <div class="propert-detail">
        <p><span>Asking Price: $</span>{{number_format((float)$property->L_AskingPrice)}}</p>
    </div>
    <div class="propert-detail">
    ...
    <div class="propert-detail">
        <p><span>Listing Total Fees: $</span> {{number_format((float)$property->LM_Int4_16)}}</p>
    </div>
    <div class="propert-detail">
        <p><span>Home Owner Fees: $</span> {{number_format((float)$property->LM_Dec_3)}}</p>
    </div>
    <div class="propert-detail">
        <p><span>Home Owner Total Fees: $</span> {{number_format((float)$property->LM_Dec_4)}}</p>
    </div>
    <div class="propert-detail">
        <p><span>CDF Mello Roos: $</span> {{number_format((float)$property->LM_Dec_6)}}</p>
    </div>
    <div class="propert-detail">
